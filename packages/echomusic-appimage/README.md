...
[echomusic-appimage](https://aur.archlinux.org/packages/echomusic-appimage) - EchoMusic desktop client AppImage
...
```bash
# Using yay
yay -S echomusic-appimage
# Using paru
paru -S echomusic-appimage
```

## Build

```bash
cd packages/echomusic-appimage
makepkg -si
```
...
Last Updated: 2026-08-29 00:20:10 UTC
